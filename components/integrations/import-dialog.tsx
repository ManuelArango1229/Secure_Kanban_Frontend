    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Import security findings from your DevSecOps tools.</DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-2">
              ...
              <Select value={tool} onValueChange={setTool} disabled={loading}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="owasp_zap">OWASP ZAP</SelectItem>
            ...
            {loading && (
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Importing vulnerabilities...</span>
          ...
          <div className="py-8 flex flex-col items-center justify-center space-y-4">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Imported {imported} vulnerabilities from {tool === "sonarqube" ? "SonarQube" : tool}
              </p>
            </div>
          </div>
        )}
